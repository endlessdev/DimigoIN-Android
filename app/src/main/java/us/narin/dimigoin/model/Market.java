...
public class Market {
    ...
    public Market(String marketThumbnailUrl, Integer marketNumber, Boolean marketIsSell, String marketSubject, String marketAuthor, String marketDate, Integer marketViewCount, Integer marketLikeCount){
